...
const ImportProductsOrBundlesPage = () => {
	...
	const importMutation = useMutation(
		(csvFile: File) => {
			...
			return apiServiceInstance.upload<VinistoHelperDllBaseBaseReturn>(
				`product-api/import/products-bundles?UserLoginHash=${authenticationContext.vinistoUser.loginHash}&language=${activeLanguageKey}`,
				formData,
				true
			);
		},
...
export default ImportProductsOrBundlesPage;
