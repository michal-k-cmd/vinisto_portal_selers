import { get, set, unset } from 'Helpers/lodash';
import Config from 'Config';

import { LocalStorageKey, STORAGE_PREFIX } from './constants';
...
class StorageService {
	 ...
	 */
	public removeItem(itemName: LocalStorageKey) {
		if (this.isStorageAvailable())
