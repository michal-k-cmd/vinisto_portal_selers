...
export const isNumericType = (t?: string) =>
	t === SpecificationType.NUMBER ||
	t === SpecificationType.DECIMAL_NUMBER ||
	t === SpecificationType.NUMBER_IMPERIAL ||
	t === SpecificationType.DECIMAL_NUMBER_IMPERIAL;
