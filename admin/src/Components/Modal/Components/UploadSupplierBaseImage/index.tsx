...
const UploadSupplierBaseImageModal = () => {
	...
	const handleOnSubmit = useCallback(() => {
		...
		apiServiceInstance
			.upload(
				`image-api/images?UserLoginHash=${authenticationContext?.vinistoUser?.loginHash}&ItemType=Supplier&ItemId=${itemId}&IsMain=false&RemoveBackground=false&AddBackground=false`,
				formData,
				true
			)
			.then(() => {
...
export default UploadSupplierBaseImageModal;
