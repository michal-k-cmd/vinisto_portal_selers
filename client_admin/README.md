# Getting Started with Vinisto Client Admin APP
Vinisto Client Admin app based on [React](https://reactjs.org/) & [TypeScript](https://www.typescriptlang.org/) libraries bundled with [Webpack](https://webpack.js.org/)
...
#### [Admin development documentation](https://git.merkatos.dev/vinisto/vinisto/-/blob/feature/eshop-dev/frontend/client_admin/docs/modules.md)
