...
import { IInvoiceAddressBoxProps } from './interfaces';
...
const InvoiceAddressBox = (props: IInvoiceAddressBoxProps) => {
	...
	return (
		...
		>
			...
			>
				...
				<div className="vinisto-address__edit-delete">
					...
					{isLoading ? (
						...
						<div
							className="vinisto-address__edit-delete__delete"
			...
			{isLoading ? (
				...
				<>
					<div>{get(props, 'data.ico', '-')}</div>
					<div>{get(props, 'data.company', '-')}</div>
					...
					{props?.data?.email && (
						<div className="vinisto-address_email">
...
export default InvoiceAddressBox;
